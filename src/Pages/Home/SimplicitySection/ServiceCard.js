    ...
    return (
        <div className='bg-[#222125] rounded-[50px] h-[396px]'>
            ...
            <div className='text-white text-center mt-[13px] px-[30px]'>
                ...
                <button className={`${colorOfBtnContent} w-full font-semibold text-sm py-[13px] px-[39px] bg-[#2E2D32] hover:bg-[#52C1B9] hover:text-white duration-300 rounded-[40px] mt-[10px]`} >{contentOfButton}</button>
            </div>
        </div>
    );
};
