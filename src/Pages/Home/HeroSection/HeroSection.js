        ...
        <div>
            ...
            <div className='relative'>
                ...
                <div className='w-[1200px] mx-auto'>
                    ...
                    <div className='absolute lg:top-[567px] bottom-[200px] lg:text-start text-center'>
                        <p className='text-[#52C1B9] w-[458px] lg:text-[25px] text-base font-semibold pl-[13px]'>The World’s First Pre-NFT Rights and Content Marketplace</p>
                        <div className='flex justify-center lg:justify-start'>
                            <button className='btn-outline py-[6px] pl-[11px] pr-[23px] mt-[13px] ml-[18px] flex items-center gap-1 lg:text-sm text-xs'><span className='text-[22px]'><GoPrimitiveDot></GoPrimitiveDot></span>NOW LIVE</button>
                        </div>
                    </div>
                    <div className='lg:absolute mt-[-91px] lg:mt-0 lg:bottom-[31px]'>
                        <p className='text-[#52C1B9] text-sm lg:text-[23px] font-semibold ml-[31px] mt-[147px]'>Know about the launch before everyone else</p>
                    </div>
                </div>
            </div>
